    ...
    <section className="bg-section-emerald-subtle">
      <div className="mx-auto max-w-6xl px-6 py-16 md:px-8 md:py-20">
        <SectionHeading
          className="mb-8"
          title="More work"
          description="Side projects and experiments that keep my curiosity sharp."
        />
        <div className="grid gap-6 md:grid-cols-2">
          {supportingProjects.map((project) => (
            ...
            >
              ...
              <p className="text-sm font-semibold bg-gradient-to-r from-accent-orange-500 to-emerald-500 bg-clip-text text-transparent">
                {project.result}
              </p>
